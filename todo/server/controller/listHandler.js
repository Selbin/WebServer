...
const createList = async (req, res) => {
  ...
  try {
    ...
    res.status(500).send(createError(500, 'list creation failed'))
  }
}
...
const updateList = async (req, res) => {
  ...
  try {
    ...
    else res.status(404).send(createError(404, 'list not found'))
  } catch (e) {
    res.status(500).send(createError(500, 'list updation failed'))
  }
}
...
const deleteList = async (req, res) => {
  ...
  try {
    ...
    res.status(500).send(createError(500, 'list deletion failed'))
  }
}
